...
export class Api {
     ...
     * @param {Record<string, any>} payload - Data payload to send in request body.
     * @param {HeadersInit} [headers] - Additional headers for the request.
     * @returns {Promise<any>} - Returns a promise resolving with the JSON data.
     */
    public async post<T = any>(endpoint: string, payload: Record<string, any>, headers: HeadersInit = {}): Promise<T> {
     ...
     * @returns {Promise<any>} - Returns a promise resolving with the JSON data.
     */
    public async put<T = any>(endpoint: string, payload: Record<string, any>, headers: HeadersInit = {}): Promise<T> {
     ...
     */
    private async _fetch<T = any>(method: string, endpoint: string, options: FetchOptions = {}): Promise<T> {
